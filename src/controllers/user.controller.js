...
import { getUserInfoProvider, getUserLikeList, getUserHistory, getUserRecent } from "../providers/user.provider.js";
...
export const getRecent = async (req, res ) => {
    res.send(response(status.SUCCESS, await getUserRecent(req.params.userId, req.query)));
}
